...
public class TransformationHarness {
     ...
     */
    public static boolean isSameSourceCode(String path) throws FileNotFoundException, ParseException {
        List<Obfuscator> obfList = new ArrayList<Obfuscator>();
        obfList.add(null);
        return isSameSourceCode(path, obfList);
    }
     ...
     * 
     * @param path path to file to test
     * @param obf list of obfuscators, null if no obfuscation is to be performed
     * @return true if the code output from 1st run is the same as the output from the 2nd run
     * @throws FileNotFoundException
     * @throws ParseException 
     */
     ...
     * @throws ParseException 
     */
    public static boolean isSameSourceCode(String path, List<Obfuscator> obfList) throws FileNotFoundException, ParseException {
